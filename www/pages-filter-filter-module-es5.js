...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-filter-filter-module"], {
  ...
  function srcAppPagesFilterFilterRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    FilterPageRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  function srcAppPagesFilterFilterModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    FilterPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  function srcAppPagesFilterFilterPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    */
    ...
    /*#__PURE__*/
    function () {
      function FilterPage(router, navCtrl, platform) {
        _classCallCheck(this, FilterPage);

        this.router = router;
        this.navCtrl = navCtrl;
        this.platform = platform;
        this.filters = ['Most Popular', 'Price High to Low', 'Price Low to High', 'Nearest to me'];
      ...
      _createClass(FilterPage, [{
        ...
        key: "click_filter",
        value: function click_filter(value) {
          console.log(value);
          this.id = value;
        }
      }, {
        key: "click_filter_cuisines",
        value: function click_filter_cuisines(value) {
          console.log(value);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"]])], FilterPage);
    /***/
  }
}]);
